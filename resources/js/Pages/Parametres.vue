...
const ratioBarZones = ref({ okW: 30, warnW: 10, badW: 20, overW: 40 });
...
function updateRatioBar() {
    ...
    ratioBarZones.value = { okW, warnW, badW, overW };
}
...
<template>
    <div class="flex-1 bg-bg p-5 overflow-y-auto">
        ...
        <p class="text-[10px] text-muted mb-5 leading-relaxed">
            Configurez les seuils de détection des anomalies. Ces seuils sont utilisés dans l'analyse 
            et les statistiques pour qualifier les ratios de frais d'approche et les coûts individuels.
            Les seuils OK/Warn/Bad définissent respectivement les plages normale, d'alerte et d'anomalie.
        </p>
        ...
        <div class="space-y-6">
                ...
                <div class="border border-border rounded-lg overflow-hidden">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full shrink-0" :style="{ backgroundColor: cost.color }"></span>
            ...
            <div class="flex justify-end">
                <button
                    @click="handleSave"
                    :disabled="saving"
                    class="px-6 py-2.5 rounded-lg bg-gradient-to-br from-navy to-[#1e4a8a] text-white shadow font-sans text-xs font-bold cursor-pointer border-none hover:shadow-md transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
                >
